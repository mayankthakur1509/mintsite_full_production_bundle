...
var manifest_default = {
  ...
  timestamp: "2025-12-24T05:36:45.045Z"
};
...
function VFLP_CEO({ persona, lawyer, practice, model }) {
  return /* @__PURE__ */ import_react8.default.createElement("div", { className: "mintsite" }, /* @__PURE__ */ import_react8.default.createElement("section", { className: "hero" }, /* @__PURE__ */ import_react8.default.createElement("h1", null, practice.name, " \u2014 CEO View"), /* @__PURE__ */ import_react8.default.createElement("p", null, "Growth, expansion, global stability.")), /* @__PURE__ */ import_react8.default.createElement(ValuePillars, { pillars: model.value_map }), /* @__PURE__ */ import_react8.default.createElement(OutcomeBlock, { outcomes: model.outcomes }), /* @__PURE__ */ import_react8.default.createElement(CaseStudies, { items: model.case_studies, persona: "ceo" }));
}
__name(VFLP_CEO, "VFLP_CEO");

// src/components/VFLP_CFO.jsx
var import_react9 = __toESM(require_react(), 1);
function VFLP_CFO({ persona, lawyer, practice, model }) {
  return /* @__PURE__ */ import_react9.default.createElement("div", { className: "mintsite" }, /* @__PURE__ */ import_react9.default.createElement("section", { className: "hero" }, /* @__PURE__ */ import_react9.default.createElement("h1", null, practice.name, " \u2014 CFO View"), /* @__PURE__ */ import_react9.default.createElement("p", null, "Financial clarity, compliance, risk mitigation.")), /* @__PURE__ */ import_react9.default.createElement(ValuePillars, { pillars: model.value_map }), /* @__PURE__ */ import_react9.default.createElement(OutcomeBlock, { outcomes: model.outcomes }), /* @__PURE__ */ import_react9.default.createElement(CaseStudies, { items: model.case_studies, persona: "cfo" }));
}
__name(VFLP_CFO, "VFLP_CFO");

// src/components/VFLP_GC.jsx
var import_react10 = __toESM(require_react(), 1);
function VFLP_GC({ persona, lawyer, practice, model }) {
  return /* @__PURE__ */ import_react10.default.createElement("div", { className: "mintsite" }, /* @__PURE__ */ import_react10.default.createElement("section", { className: "hero" }, /* @__PURE__ */ import_react10.default.createElement("h1", null, practice.name, " \u2014 General Counsel View"), /* @__PURE__ */ import_react10.default.createElement("p", null, "Compliance certainty, minimized exposure, defensible decisions.")), /* @__PURE__ */ import_react10.default.createElement(ValuePillars, { pillars: model.value_map }), /* @__PURE__ */ import_react10.default.createElement(OutcomeBlock, { outcomes: model.outcomes }), /* @__PURE__ */ import_react10.default.createElement(CaseStudies, { items: model.case_studies, persona: "gc" }));
}
...
var renderer = {
  render: /* @__PURE__ */ __name(async (componentName, props) => {
    ...
    return import_server.default.renderToString(
      import_react11.default.createElement(Component, props)
    );
  }, "render")
};
...
var worker_default = {
  async fetch(req, env, ctx) {
    ...
    const htmlBody = await renderer.render(route.component, route.props);
    const fullHTML = `
    <!DOCTYPE html>
    <html lang="en">
    <head>
...
// .wrangler/tmp/bundle-nUzDV8/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-nUzDV8/middleware-loader.entry.ts
